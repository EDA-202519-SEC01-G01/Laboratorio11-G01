def new_pq_entry(key, value):
    ...
    - :attr:`key`: Llave de la entrada. Inicializada con el valor recibido ``key``.
    - :attr:`value`: Valor asociado a la entrada. Inicializado con ``value``.
    - :attr:`index`: Índice de la entrada en la cola. Inicializada con el valor ``None``.
